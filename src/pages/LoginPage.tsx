...
function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex justify-center items-center bg-bl">
      ...
      <div className="flex text-white rounded-3xl shadow-2xl  w-full  justify-center ">
        {/* Left Side - Image & Logos */}
        <div className="hidden md:flex flex-col items-center bg-black p-100 px-0 py-0 h-screen w-[100%]">
        ...
        <section className=" flex flex-col justify-start bg-[#0C1327] w-full sm:w-[60%] ">
